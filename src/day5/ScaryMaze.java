...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("163356__pacmangamer__video-distortion-malfunction.wav"));
		...
		showScaryImage("scaryscarescare.jpg");

	}

	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource("scaryscarescare.jpg"));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + "scaryscarescare.jpg");
		}
		repaint();
	}
